...
class EmpresaPickerResult {
  ...
  factory EmpresaPickerResult.cleared() =>
      const EmpresaPickerResult(idProprietario: null, nome: null, cleared: true);
                  ...
                  if (allowNull)
                    Align(
                      ...
                      child: TextButton.icon(
                        onPressed: () =>
                            Navigator.of(ctx).pop(EmpresaPickerResult.cleared()),
                  ...
                  Expanded(
                    child: filtrados.isEmpty
                        ...
                        : ListView.separated(
                            ...
                            itemBuilder: (_, i) {
                              final p = filtrados[i];
                              final bloqueado = p.status == 'bloqueado';
                              return ListTile(
                                dense: true,
                                title: Text(
                                ...
                                onTap: () => Navigator.of(ctx)
                                    .pop(EmpresaPickerResult.fromProprietario(p)),
                              );
                            },
                          ),
                  ),
