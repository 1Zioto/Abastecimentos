      ...
      <form [formGroup]="form" (ngSubmit)="onSubmit()" class="form-card">
        <div class="form-grid">
          ...
          <div class="field">
            ...
            <input type="text" formControlName="vgm_vinculado" placeholder="Informe o VGM vinculado" />
          </div>
...
export class LancarSofitComponent implements OnInit {
  ...
  onSubmit() {
    ...
    // Tela "Lançar no Sofit" ainda não está integrada com o sistema Sofit.
    // A lógica real de envio será definida posteriormente.
