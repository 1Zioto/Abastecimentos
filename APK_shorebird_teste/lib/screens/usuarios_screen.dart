...
class _UsuariosScreenState extends State<UsuariosScreen> {
  ...
  Future<void> _abrirForm([Usuario? original]) async {
    ...
    var filiaisSelecionadas = [
      ...(original?.filiaisAcesso ?? AppConstants.locais)
    ];
    if (filiaisSelecionadas.isEmpty) {
      filiaisSelecionadas = [...AppConstants.locais];
    }
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                ...AppConstants.locais.map(
                  (filial) => CheckboxListTile(
                    dense: true,
                    contentPadding: EdgeInsets.zero,
                    value: filiaisSelecionadas.contains(filial),
                    title: Text(filial),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    labelText:
                        original == null ? 'Senha' : 'Nova senha (opcional)',
                  ),
                ),
              ],
            ),
    ...
    if (filiaisSelecionadas.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: Text('Selecione ao menos uma filial.'),
    ...
    final usuario = Usuario(
      ...
      filiaisAcesso: filiaisSelecionadas,
    );
          ...
          ? ListView(
              children: const [
                ...
                EmptyState(
                  ...
                  mensagem:
                      'Sincronize para carregar os usuarios ou crie um novo.',
                ),
              ],
            )
          : ListView.builder(
